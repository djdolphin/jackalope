...
public class Specs {
	...
	public static var commands:Array = [
		...
		["ask %s in dialog",					" ", 7, "askInDialog",			"What's your name?"],
		["answer",								"r", 7, "answer"],
		["-"],
		["show dialog titled %s with text %s",	" ", 7, "showDialog", "Message", "Hello!"],
		["-"],
		...
		["ask %s in dialog",					" ", 107, "askInDialog",		"What's your name?"],
		["answer",								"r", 107, "answer"],
		["-"],
		["show dialog titled %s with text %s",	" ", 107, "showDialog", "Message", "Hello!"],
		["-"],
